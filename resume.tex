...
\documentclass[paper=a4,fontsize=9pt]{scrartcl} % KOMA-article class
	...
	\WorkEntry{Senior Software Engineer, Robotics}{2020 - 2022}{EquipmentShare}{
		\begin{itemize}
			...
			\item Wrote and implemented a system for training large scale Computer Vision models based on validation and testing data gathered from the real world and sanitized.
			\item Developed a pipeline for the recording and replay of sensor data from the robot, including a real-time visualization system for reviewing defects and segmentation results.
			...
			\item Guided a team of interns in developing a custom depth estimation and segmentation system for obstacle detection from video data.
		\end{itemize}
	}
	\sepspace
